...
public class HWMediaScreenEncoder extends HWMediaVideoEncoderBase {
	private static final String TAG = HWMediaScreenEncoder.class.getSimpleName();
	...
	public HWMediaScreenEncoder(MediaMuxerWrapper muxer, MediaEncoderListener listener, MediaProjection projection, VideoSetting videoSetting, int density, List<CustomDecorator> decorators) {
	...
	public void prepare() throws IOException {
		...
		if(mSurface==null){
			throw new RuntimeException("mSurface is null");
		}
        mMediaCodec.start();
        mIsRecording = true;
