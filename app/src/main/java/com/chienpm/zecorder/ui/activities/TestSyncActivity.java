...
import com.chienpm.zecorder.ui.adapters.TestSyncVideoAdapter;
...
public class TestSyncActivity extends AppCompatActivity {
    ...
    private TestSyncVideoAdapter mSyncAdapter;
    ...
    private void bindAdapterAndLoadData() {
        mSyncAdapter = new TestSyncVideoAdapter(this, new ArrayList<Video>());
...
//        mSyncAdapter.getView(0, null, null).findViewById(R.id.sync_progressBar).setVisibility(View.GONE);
    ...
    private void initView() {
        ...
        Intent intent = new Intent(this, TestSyncActivity.class);
