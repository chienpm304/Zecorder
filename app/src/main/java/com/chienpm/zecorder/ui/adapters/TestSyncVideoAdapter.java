...
public class TestSyncVideoAdapter extends ArrayAdapter<Video> {
    ...
    private final TestSyncActivity mActivity;
    ...
    public TestSyncVideoAdapter(TestSyncActivity syncActivity, ArrayList<Video> videos) {
